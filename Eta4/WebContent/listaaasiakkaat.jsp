...
<table id="listaus">
	<thead>		
		<tr>
			...
			<th> <a href="lisaa_asiakas.jsp" class="sivu_linkki" id="lisaa_asiakas">Lisää asiakas</a></th>
		</tr>
		<tr>
...
function poista(asiakas_id, etunimi, sukunimi){
	if(confirm("Poista asiakas " + etunimi + " " + sukunimi +"?")){	
		...
		.then(function (responseJson) {		
			...
			if(vastaus==0){
				document.getElementById("ilmo").innerHTML= "Asiakkaan tietojen poisto epäonnistui.";
	        }else if(vastaus==1){	        	
